...
export default function GenderSelect({ handleRegisterChange, genderError }) {
    ...
    return (
        ...
        style={{ marginBottom: `${genderError && !view3 ? "60px" : ""}` }}
        >
            <label htmlFor="male">
                Male
            ...
            <label htmlFor="others">
                Others
                <input type="radio" name="gender" id="others" value="others" onChange={handleRegisterChange} />
            </label>
            {genderError &&
                <div className={!view3 ? "input_error" : "input_error input_error_select_large"}>
                <div className={!view3 ? "error_arrow_bottom_second" : "error_arrow_left"}></div>
                {genderError}
            </div>
            }
        </div>
